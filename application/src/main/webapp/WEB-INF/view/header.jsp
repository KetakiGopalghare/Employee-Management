...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    %>
      ...
      <li class="nav-item">
        <a class="nav-link" href="/listofemployees">List of Employees  </a>
      </li>

      
      <li class="nav-item">
        <a class="nav-link" href="/editemployee?emp=<%=session.getAttribute("username")%>&message=NULL">Profile(<%=session.getAttribute("username")%>)</a>
      </li>
      <li class="nav-item">
